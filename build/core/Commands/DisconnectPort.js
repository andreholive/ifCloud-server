...
var DisconnectPort = /** @class */ (function (_super) {
    __extends(DisconnectPort, _super);
    function DisconnectPort(commandData) {
        ...
        _this.function = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, this.engine._cloudMngr.disconnectDevice(this.data, this.user)];
                    case 1:
                        _a.sent();
                        this.data.removeGateway();
                        return [4 /*yield*/, this.engine._databaseMngr.updatePortState(this.data.getPortData())];
                    case 2:
                        _a.sent();
...
exports.default = DisconnectPort;
