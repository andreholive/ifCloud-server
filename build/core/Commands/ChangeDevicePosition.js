...
var ChangeDevicePosition = /** @class */ (function (_super) {
    __extends(ChangeDevicePosition, _super);
    function ChangeDevicePosition(commandData) {
        ...
        _this.function = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.engine._databaseMngr.updateDevicePosition(this.data.deviceId, this.data.position)];
                    case 1:
                        _a.sent();
    ...
    return ChangeDevicePosition;
}(Command_1.default));
exports.default = ChangeDevicePosition;
