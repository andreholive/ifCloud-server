...
var ConnectPort = /** @class */ (function (_super) {
    __extends(ConnectPort, _super);
    function ConnectPort(commandData) {
        ...
        _this.function = function () { return __awaiter(_this, void 0, void 0, function () {
            var networkData, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, this.engine._cloudMngr.connectDevice(this.data, this.user)];
                    case 1:
                        networkData = _a.sent();
