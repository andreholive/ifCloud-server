...
var Reboot = /** @class */ (function (_super) {
    __extends(Reboot, _super);
    function Reboot(commandData) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.engine._cloudMngr.instanceReboot(device.getDeviceData(), this.user)];
                    case 1:
                        _a.sent();
