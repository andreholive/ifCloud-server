...
var GetInstanceStatus = /** @class */ (function (_super) {
    __extends(GetInstanceStatus, _super);
    function GetInstanceStatus(commandData) {
        ...
        _this.function = function () { return __awaiter(_this, void 0, void 0, function () {
            var instancesInfos, error_1;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.engine._cloudMngr.getInstanceInformations(this.user)];
                    case 1:
                        instancesInfos = _a.sent();
                        instancesInfos.forEach(function (info) {
                            var device = _this.diagram.getDeviceByInstanceId(info.id);
                            if (device) {
                                ...
                                if (status != device.getStatus()) {
                                    _this.response.sendCommand(CommandManager_1.DiagramFunction.updateInstanceStatus, device.getDeviceData());
                                }
                            }
                        });
                        return [3 /*break*/, 3];
...
exports.default = GetInstanceStatus;
