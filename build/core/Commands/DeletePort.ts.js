...
var DeletePort = /** @class */ (function (_super) {
    __extends(DeletePort, _super);
    function DeletePort(commandData) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [4 /*yield*/, this.engine._databaseMngr.deletePort(this.data)];
                    case 3:
                        _a.sent();
