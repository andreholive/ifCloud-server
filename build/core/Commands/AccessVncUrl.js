...
var AccessVncUrl = /** @class */ (function (_super) {
    __extends(AccessVncUrl, _super);
    function AccessVncUrl(commandData) {
        ...
        _this.function = function () { return __awaiter(_this, void 0, void 0, function () {
            var device, url, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        device = this.diagram.selectDeviceById(this.data);
                        if (!device) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.engine._cloudMngr.getConsoleUrl(device.getDeviceData(), this.user)];
                    case 1:
                        url = _a.sent();
                        this.response.send({ url: url });
                        _a.label = 2;
