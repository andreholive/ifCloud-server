...
var CreateDevice = /** @class */ (function (_super) {
    ...
    function CreateDevice(commandData) {
        ...
        _this.function = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.response = new ResponseCommand_1.default(commandData);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 7, , 8]);
                        if (!(this.data.device === 3)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.createInstance()];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3:
                        if (!(this.data.device === 1)) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.createRouter()];
                    case 4:
                        _a.sent();
                        this.data.status = 1;
                        _a.label = 5;
                    case 5:
                        ...
                        return [4 /*yield*/, this.engine._databaseMngr.createDevice(this.data)];
                    case 6:
                        _a.sent();
                    ...
                    case 7:
                        error_1 = _a.sent();
                        this.response.sendCommand(CommandManager_1.DiagramFunction.removeDevice, this.data);
    ...
    CreateDevice.prototype.createInstance = function () {
        return __awaiter(this, void 0, void 0, function () {
            var instanceId, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.engine._cloudMngr.addInstance(this.data, this.user)];
                    case 1:
                        instanceId = _a.sent();
    ...
    CreateDevice.prototype.createRouter = function () {
        return __awaiter(this, void 0, void 0, function () {
            var instanceId, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.engine._cloudMngr.createRouter(this.data, this.user)];
                    case 1:
                        instanceId = _a.sent();
                        this.data.instanceId = instanceId;
                        return [3 /*break*/, 3];
