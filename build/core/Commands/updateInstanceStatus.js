...
var UpdateInstanceStatus = /** @class */ (function (_super) {
    __extends(UpdateInstanceStatus, _super);
    function UpdateInstanceStatus(commandData) {
        ...
        _this.function = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.engine._databaseMngr.updateDeviceData(this.data)];
                    case 1:
                        _a.sent();
...
exports.default = UpdateInstanceStatus;
