...
var ResponseCommand = /** @class */ (function () {
    ...
    ResponseCommand.prototype.sendCommand = function (command, data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.session._engine._cmdMngr.execute({ user: this.user, command: command, data: data, session: this.session })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    ResponseCommand.prototype.sendToAllUsers = function (data) {
        var users = this.session.getUsers();
        this.session.fireEvent(data, this.session.id, this.command);
        for (var id in users) {
