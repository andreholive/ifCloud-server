...
var PowerOn = /** @class */ (function (_super) {
    __extends(PowerOn, _super);
    function PowerOn(commandData) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.engine._cloudMngr.instancePowerOn(device.getDeviceData(), this.user)];
                    case 1:
                        _a.sent();
