...
var PowerOff = /** @class */ (function (_super) {
    __extends(PowerOff, _super);
    function PowerOff(commandData) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.engine._cloudMngr.instancePowerOff(device.getDeviceData(), this.user)];
                    case 1:
                        _a.sent();
